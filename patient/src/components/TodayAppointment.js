...
function TodayAppointment() {
    ...
    const fetchtodaysappointment = async () => {
        ...
        try {
            const res = await axios.get(`http://localhost:8080/getTodaysAppointment`)
            ...
            if (res.data.length !== 0) {
                ...
                setDataExists(false)
                console.log('Does appointments exists', dataexists)
            }
    ...
    return (
        <div>
            ...
            <div id="appointment_mid_sec">
                ...
                <div id="appoint_mid_sec_date">
                    <h4>Date : <span>{((new Date()).getDate()) + "/" + ((new Date()).getMonth() + 1) + "/" + ((new Date()).getFullYear())}</span></h4>
                </div>

                {/* <div className="search_bar">
                    <form name="searchbyname" method="post" onSubmit={handlesubmit}>
